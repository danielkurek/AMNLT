...
config_path="configs/smt_dan/merged/orig_merged.json"
...
separate_datasets_info="Solesmes_staffLevel;s-gabc;3
Einsiedeln_staffLevel;mei-gabc;1
Salzinnes_staffLevel;mei-gabc;2
GregoSynth_staffLevel;gabc;0"
