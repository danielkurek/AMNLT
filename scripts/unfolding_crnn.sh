...
while IFS= read -r LINE; do
    ...
    python "$base_dir/AMNLT_original_models/AMNLT/scripts/dc_base_unfolding_trocr/train.py" --ds_name "$datasets_base_dir/$name" --model_name crnnunfolding --encoding_type "$encoding_type" --ctc greedy --batch_size 1
